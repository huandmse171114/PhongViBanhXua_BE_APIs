...
@RestControllerAdvice(basePackages = "com.phongvi.product_category.controller")
public class ProductCategoryControllerAdvice {
	
	private static Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
		      "tbl_productcategory_name_key", "Tên danh mục sản phẩm đã tồn tại. Vui lòng thử lại.");
